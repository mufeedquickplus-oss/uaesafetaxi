UAE Safe Travel - Fixed Working Version

This is a clean rebuilt version after interaction issues.

Working behavior:
- Book on WhatsApp opens the hidden booking form.
- Service cards open the same form with the selected service reason.
- Footer service links open the same form with the selected service reason.
- Submit button opens WhatsApp with form details.
- Complaint links open WhatsApp complaint message.
- Mobile menu works.
- No emoji icons in visible content.
- Corporate glossy taxi-yellow visual style.
...
- Visible phone number removed from the page. Call actions say only "Call".
